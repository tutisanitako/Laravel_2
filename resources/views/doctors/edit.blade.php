                    ...
                    <form method="POST" action="{{ route('doctors.update', $doctor) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone', $doctor->user->phone)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address', $doctor->user->address)" />
                            ...
                            <div>
                                ...
                                <x-text-input id="room_number" class="block mt-1 w-full" type="text" name="room_number" :value="old('room_number', $doctor->room_number)" />
                                <x-input-error :messages="$errors->get('room_number')" class="mt-2" />
                            </div>
                        </div>

                        <div class="flex items-center justify-end mt-6 gap-4">
                            <a href="{{ route('doctors.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                                Cancel
                            </a>
                            <x-primary-button>
                                {{ __('Update Doctor') }}
